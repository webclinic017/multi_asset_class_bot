...
('Market Making HFT', 'High-frequency market making strategy that profits from bid-ask spreads by simultaneously placing buy and sell orders', 'hft', 'futures', '1m', '{"spread_width": 0.25, "max_inventory": 10, "inventory_rebalance_threshold": 3, "quote_refresh_time": 5, "min_spread": 0.25, "max_spread": 2.0, "volatility_lookback": 20, "risk_limit": 0.02, "max_orders_per_side": 3, "order_size": 1, "adaptive_spread": true, "printlog": false}'),
