...
('Market Making HFT Strategy', 'High-frequency market making strategy for futures contracts that profits from bid-ask spreads', 'hft', 'futures', '1h', '{"spread_width": 0.0002, "max_inventory": 10, "inventory_rebalance_threshold": 3, "quote_refresh_time": 5, "min_spread": 0.0001, "max_spread": 0.001, "volatility_lookback": 20, "risk_limit": 0.02, "max_orders_per_side": 3, "order_size": 1, "adaptive_spread": true}'),
('Statistical Arbitrage HFT Strategy', 'High-frequency statistical arbitrage strategy that exploits mean-reverting relationships between futures contracts', 'hft', 'futures', '1h', '{"lookback_period": 100, "entry_threshold": 2.0, "exit_threshold": 0.5, "max_holding_time": 300, "min_relationship_strength": 0.7, "max_position_size": 5, "risk_limit": 0.01, "cointegration_test_period": 50, "zscore_smoothing": 5, "adaptive_threshold": true, "pairs_update_interval": 3600}'),
('Latency Arbitrage HFT Strategy', 'High-frequency latency arbitrage strategy that exploits price discrepancies across different futures exchanges', 'hft', 'futures', '1m', '{"latency_threshold": 0.0001, "max_holding_time": 60, "min_profit_threshold": 0.00005, "risk_limit": 0.005, "max_position_size": 3, "order_refresh_time": 1, "exchange_comparison_window": 10, "profit_taking_threshold": 0.0002, "stop_loss_multiplier": 2.0}'),
('Momentum Ignition HFT Strategy', 'High-frequency momentum ignition strategy that creates artificial momentum to profit from other market participants', 'hft', 'futures', '1m', '{"momentum_threshold": 0.001, "ignition_volume": 5, "max_holding_time": 30, "profit_target": 0.0005, "stop_loss": 0.0002, "volume_surge_threshold": 2.0, "momentum_decay_time": 15, "risk_limit": 0.01, "max_trades_per_minute": 10}');
